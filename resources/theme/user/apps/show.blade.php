            ...
            <div class="dark:bg-gray-700 p-6">
                ...
                <div class="flex space-x-2 mt-4">
                    <x-shadow::action-confirm-modal
                        ...
                        :method="'DELETE'"
                        :title="__('shadow.delete')"
                        :trigger="__('shadow.delete')"
                    />
                    <x-shadow::model
                        :trigger="__('shadow.add_api_product')"
                        :title="__('shadow.add_api_product')"
                        trigger-class="btn btn-sm btn-primary dark:text-white"
                    >
                        @php
                    ...
                    <x-shadow::model
                        :trigger="__('shadow.remove_api_product')"
                        :title="__('shadow.remove_api_product')"
                        trigger-class="btn btn-sm btn-primary dark:text-white"
                    >
                        @php
                        $added_products = collect($key->getApiProducts())->pluck('apiproduct','apiproduct')->toArray();
